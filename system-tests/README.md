...
The integration suite in `backend/src/test/java/com/fpt/backend/it` provides its
own SQL Server and Redis through Testcontainers. It covers login/JWT, invalid
