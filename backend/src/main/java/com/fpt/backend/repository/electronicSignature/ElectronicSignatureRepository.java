...
>>>>>>> 7d6eb51fe9c660b46d1a1bc0200bcbbc73cf5f51
    ...
    """)
        ...
        @Query("""
                        ...
                        """)
        List<ListElectronicResponse> getAllElectronicSignaturesById(@Param("userId") UUID userId);>>>>>>>origin
    ...
    ElectronicSignatureDetailResponse getElectronicSignaturesById(@Param("userId") UUID userId, @Param("signatureId") UUID signatureId);
        ...
        HEAD Optional<ElectronicSignatures> findByIdAndUserIdAndStatus(
            UUID id,
            UUID userId,
