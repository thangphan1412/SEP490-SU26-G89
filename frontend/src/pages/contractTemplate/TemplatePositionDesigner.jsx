...
const STANDARD_FIELDS = [
    ...
    {
        key: "party_a_date_of_birth",
        label: "Party A Date of Birth",
        fieldType: "DATE",
        valueSource: "CURRENT_SIGNER",
        signerRole: "DIRECTOR",
        systemField: true,
    ...
    {
        key: "party_a_department",
        label: "Party A Department",
        fieldType: "TEXT",
        valueSource: "CURRENT_SIGNER",
        signerRole: "DIRECTOR",
        systemField: true,
    ...
    },
    {
        ...
        required: false,
        icon: IconUser,
        sample: "E-CONTRACT Company",
    },
    {
        key: "party_b_name",
        label: "Party B Full Name",
        fieldType: "TEXT",
        valueSource: "CURRENT_SIGNER",
        signerRole: "PARTNER",
        systemField: true,
    ...
    {
        key: "party_b_date_of_birth",
        label: "Party B Date of Birth",
        fieldType: "DATE",
        valueSource: "CURRENT_SIGNER",
        signerRole: "PARTNER",
        systemField: true,
    ...
    {
        key: "party_b_department",
        label: "Party B Department",
        fieldType: "TEXT",
        valueSource: "CURRENT_SIGNER",
        signerRole: "PARTNER",
        systemField: true,
    ...
    return (
        <section className="template-simple-editor">
            <header className="template-simple-editor-header">
                <div>
                    <h3>Build Complete Contract Document</h3>
                    <p>
                        Edit every line in the document, from headings and party
                        details to clauses and signature areas. Each tab is a page.
                    </p>
                </div>
