...
const localStyles = {
    toolbar: { display: "grid", gridTemplateColumns: "minmax(300px, 1fr) 150px 230px 126px 54px", gap: 18, alignItems: "center", padding: "26px 32px" },
    ...
    footer: { height: 82, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 42px", color: "#52617f", fontSize: 14 },
